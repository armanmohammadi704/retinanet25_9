...
def default_classification_model(
    ...
    outputs = keras.layers.Reshape((-1, 9,num_classes), name='pyramid_classification_reshape')(outputs)
...
def default_regression_model(num_values, num_anchors, pyramid_feature_size=256, regression_feature_size=256, name='regression_submodel'):
    ...
    outputs = keras.layers.Reshape((-1, 9,num_values), name='pyramid_regression_reshape')(outputs)
